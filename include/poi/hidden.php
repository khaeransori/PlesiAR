				<?php
					$query 		= "SELECT * FROM poi WHERE status = 'hidden' ORDER BY id DESC";
				...
				<div id="modal-delete" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="map-modalLabel" aria-hidden="true">
					...
					<div class="modal-footer">
						<a href="process.php?what=poi&act=delete&hidden=true&id=" class="btn btn-danger">Yes</a>
